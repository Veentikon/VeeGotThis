...
import { type RowProps, useDayPicker, Day, WeekNumber } from "react-day-picker";
  ...
  return (
    ...
    >
      <Calendar
        ...
        components={{
        //   Head: () => <></>,
        //   Row: (props: unknown) => <CustomRow rowProps={props} data={data} />,
        }}
      />
...
function CustomRow(props: CustomRowProps): JSX.Element {
  ...
  let weekNumberCell;
  if (rowProps.weekNumber !== undefined) {
    weekNumberCell = (
    //   <td className={classNames.day} style={styles.day}>
        <td className={classNames.day} style={styles?.day} role="presentation">
        <WeeknumberComponent
